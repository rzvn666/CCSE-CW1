        ...
        <div class="container px-4 px-lg-5">
            <div class="row gx-4 gx-lg-5">
                <div class="col-md-10 col-lg-8 mx-auto text-center">
                    <h1 class="p-4 mx-auto my-0 text-white">Are you lost?</h1> 
                    <h1 class="mx-auto my-0 text-white">Don't worry, <a href = 'cars.php'>click here</a> to go back to viewing our cars.</h1>
                </div>
            </div>
        </div>
        </section>
