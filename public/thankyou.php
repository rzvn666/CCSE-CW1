...
<html lang="en">
    <head>
        ...
        <title>Global Finance - Thank You</title>
        ...
        <div class="container px-4 px-lg-5">
            <div class="row gx-4 gx-lg-5">
                <div class="col-md-10 col-lg-8 mx-auto text-left">
                    <h1 class="mx-auto my-0 text-white"> Thank you for your application.</h1> 
                    <h1 class="mx-auto my-0 text-white">Please allow 3-5 business days for your application to be processed.</h1>
                </div>
            </div>
        </div>
        </section>
